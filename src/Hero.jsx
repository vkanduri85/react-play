function Hero() {
	return (
		<>
			{/* Hero section */}
			<section id="home">
				<div className="gap-18 md:pt-45 lg:gap-35 lg:pt-47.5 flex h-full flex-col justify-between bg-[url('/images/free-layer-blur.png')] bg-cover bg-center bg-no-repeat py-8 pt-40 sm:py-16 md:gap-24 lg:py-24">
					<div className="mx-auto flex max-w-[1280px] flex-col items-center gap-6 justify-self-center px-4 text-center sm:px-6 lg:px-8">
						...
						<h1 className="text-base-content z-1 relative text-5xl font-bold leading-[1.15] max-md:text-2xl md:max-w-3xl">
							...
							<svg
								...
								viewBox="0 0 348 10"
								fill="none"
								className="-z-1 left-25 absolute -bottom-1.5 max-lg:left-4 max-md:hidden"
							>
								<path
									...
									stroke="url(#paint0_linear_17052_181397)"
									strokeWidth={2}
									strokeLinecap="round"
								/>
								<defs>
									<linearGradient
										id="paint0_linear_17052_181397"
										x1="29.7873"
										y1="1.85626"
										x2="45.2975"
										y2="69.7387"
				...
				<div className="bg-base-200 py-8 sm:py-16 lg:py-24">
					<div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
						<div className="flex flex-col gap-12 md:gap-16 lg:gap-24">
							...
							<div className="lg:h-161 relative mb-8 h-full w-full rounded-xl max-lg:space-y-6 sm:mb-16 lg:mb-24">
								<img
									src="/images/restaurant-about-us.png"
									alt="about-us"
									className="h-full w-full rounded-xl object-cover"
								/>
								{/* Stats card overlapping the video section */}
								<div className="bg-base-100 border-base-content/20 rounded-box lg:-bottom-25 intersect:motion-preset-fade intersect:motion-opacity-0 intersect:motion-duration-800 grid gap-10 border px-10 py-8 sm:max-lg:grid-cols-2 lg:absolute lg:left-1/2 lg:w-3/4 lg:-translate-x-1/2 lg:grid-cols-4 xl:w-max">
									...
									<div className="flex flex-col items-center justify-center gap-6">
										...
										<div className="space-y-2 text-center">
											<span
												...
												id="count2"
											/>
											<p className="text-base-content/80">Dishes in Our Menu</p>
										</div>
									</div>
									...
									<div className="flex flex-col items-center justify-center gap-6">
										...
										<div className="space-y-2 text-center">
											<span
												...
												id="count4"
											/>
											<p className="text-base-content/80">Happy Customers</p>
										</div>
									</div>
								</div>
							</div>
				...
				<div className="bg-base-100 py-8 sm:py-16 lg:py-24">
					<div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
						...
						<div className="mb-12 space-y-4 text-center sm:mb-16 lg:mb-24">
							...
							<p className="text-base-content/80 text-xl">
								From unforgettable flavors to seamless service, we’re here to
								make every meal feel special. Whether you dine in, take out, or
								order online we’ve got your cravings covered.
							</p>
						</div>
						{/* Blog Grid */}
						<div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
							...
							<div className="card card-border shadow-none">
								<figure>
									<img src="/images/free-blog-1.png" alt="Vegetable Market" />
								</figure>
								<div className="card-body gap-3">
									<h5 className="card-title text-xl">Buffet Service</h5>
									<p className="mb-5">
										Navigate effortlessly with our intuitive design, optimized
										for all devices. Enjoy a seamless experience whether you're
							...
							<div className="card card-border shadow-none">
								<figure>
									<img src="/images/free-blog-2.png" alt="Delivery Service" />
								</figure>
								<div className="card-body gap-3">
									<h5 className="card-title text-xl">Food delivery</h5>
									<p className="mb-5">
										Enjoy a safe shopping experience with multiple payment
										options and SSL encryption. Your personal and financial
							...
							<div className="card card-border shadow-none">
								<figure>
									<img src="/images/free-blog-3.png" alt="Cafeteria" />
								</figure>
								<div className="card-body gap-3">
									<h5 className="card-title text-xl">Cafeteria</h5>
									<p className="mb-5">
										Find products quickly with advanced filters, sorting
										options, and suggestion. Save time and effortlessly locate
								...
								<div className="carousel-slide">
									<div className="card card-border hover:border-primary transition-border h-full shadow-none duration-300">
										...
										<div className="card-body gap-5">
											...
											{/* Content */}
											<p className="text-base-content/80">
												Chef Marilyn’s signature curry is hands-down the best
												I’ve ever had. The flavors are bold and unforgettable!”
											</p>
										</div>
									</div>
								</div>
								...
								<div className="carousel-slide">
									<div className="card card-border hover:border-primary transition-border h-full shadow-none duration-300">
										...
										<div className="card-body gap-5">
											...
											{/* Content */}
											<p className="text-base-content/80">
												“Takahiro’s sushi is pure perfection. So fresh,
												delicate, and beautifully presented — a five-star
												experience.”
											</p>
										</div>
									</div>
								...
								<div className="carousel-slide">
									<div className="card card-border hover:border-primary transition-border h-full shadow-none duration-300">
										...
										<div className="card-body gap-5">
											...
											{/* Content */}
											<p className="text-base-content/80">
												The ambiance is amazing, and the food is even better!
												The grilled salmon was perfectly cooked. A must-try
												place!
											</p>
										</div>
									</div>
									...
									<div className="card card-border hover:border-primary transition-border h-full shadow-none duration-300">
										...
										<div className="card-body gap-5">
											...
											<div className="flex items-center gap-3">
												<div className="avatar">
													<div className="size-10 rounded-full">
														<img src="/images/avatars/12.png" alt="Jason Wu" />
													</div>
												</div>
												<div>
													<h4 className="text-base-content font-medium">
											...
											{/* Content */}
											<p className="text-base-content/80">
												The service was exceptional. From the moment we walked
												in, the staff made us feel like family.
											</p>
										</div>
									</div>
								</div>
			...
			<div className="bg-base-100 py-8 sm:py-16 lg:py-24">
				<div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
					<div className="from-primary/30 to-error/30 p-0.25 overflow-hidden rounded-3xl bg-gradient-to-r">
						<div className="bg-base-100 rounded-3xl p-0.5">
							<div className="from-primary/6 to-error/6 relative rounded-3xl bg-gradient-to-r to-50% p-8 lg:p-16">
								<div className="flex justify-between gap-8 max-md:flex-col max-sm:items-center max-sm:text-center md:items-center">
									<div className="max-w-xs space-y-4 lg:max-w-lg">
										<h2 className="text-base-content text-xl font-bold md:text-3xl">
											Order Now &amp; Satisfy Your Cravings
										</h2>
										<p className="text-base-content/80">
											Let us bring the flavors you love straight to your door.
											From classic comfort dishes to chef-curated specials,
											every bite is made with care and delivered fresh. Skip the
											wait — your next favorite meal is just a click away.
										</p>
										<a className="btn btn-gradient btn-primary" href="#">
											Read More
									...
									<img
										src="/images/mint.png"
										alt="mint"
										className="intersect-once intersect:motion-preset-slide-down-lg intersect:motion-duration-800 intersect:motion-opacity-in-0 intersect:motion-delay-100 absolute end-[21%] top-0 h-20 max-w-sm max-md:hidden"
									/>
									<img
										src="/images/pizza.png"
										alt="Pizza"
										className="rtl:rotate-y-180 absolute end-0 top-0 h-full max-w-md rounded-br-3xl max-md:hidden"
									/>
								</div>
							</div>
						</div>
			...
			<div className="via-primary/20 mx-auto h-px w-3/5 bg-gradient-to-r from-transparent to-transparent" />
			{/* Team */}
			<section id="team">
				<div className="bg-base-100 py-8 sm:py-16 lg:py-24">
					<div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
						<div className="mb-12 text-center sm:mb-16 lg:mb-24">
							...
							<p className="text-base-content/80 text-xl">
								Meet the Passionate Experts Behind Our Success and Learn More
								About Their Roles .
							</p>
						</div>
						{/* Team Members */}
						<div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
							...
							<div className="card card-border hover:border-primary h-max shadow-none">
								<figure className="bg-base-200 pt-10.5">
									<img
								...
								<div className="card-body gap-3 p-5">
									...
									<div>
										<p className="text-base-content/80 mb-1 font-medium">
											Head Chef
										</p>
										<p className="text-base-content/80">
							...
							<div className="card card-border hover:border-primary h-max shadow-none">
								...
								<div className="card-body gap-3 p-5">
									...
									<div>
										...
										<p className="text-base-content/80">
											Leading teams to build smart, scalable solutions.
										</p>
									</div>
								</div>
							</div>
							...
							<div className="card card-border hover:border-primary h-max shadow-none">
								...
								<div className="card-body gap-3 p-5">
									...
									<div>
										...
										<p className="text-base-content/80">
											Bringing designs to life with seamless interfaces.
										</p>
									</div>
								</div>
							</div>
				...
				<div className="bg-base-200 py-8 sm:py-16 lg:py-24">
					<div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
						...
						<div className="mb-12 text-center text-white sm:mb-16 lg:mb-24">
							<h2 className="text-base-content mb-4 text-2xl font-semibold md:text-3xl md:text-6xl lg:text-4xl">
								Get in Touch to Reserve Your Table
							</h2>
							<p className="text-base-content/80 text-xl">
								Whether you're planning a casual dinner or a special
								celebration, we're here to make your experience seamless.
							</p>
						</div>
						<div className="card shadow-md">
							<div className="card-body grid gap-10 lg:grid-cols-7">
								{/* Form Section */}
								<div className="lg:col-span-4">
									<h2 className="text-base-content mb-6 text-3xl font-semibold">
										Book a Table
									</h2>
											...
											<div className="w-full">
												...
												<div className="input input-lg">
													<input
														...
														id="username"
													/>
													<span className="icon-[tabler--user] text-base-content/80 size-5.5 my-auto ms-3 shrink-0" />
												</div>
											</div>
											<div className="w-full">
												<label className="label-text" htmlFor="userphone">
													Phone Number
												</label>
												<div className="input input-lg">
													<input
														...
														id="userphone"
													/>
													<span className="icon-[tabler--phone] text-base-content/80 size-5.5 my-auto ms-3 shrink-0" />
												</div>
											</div>
										</div>
										<div className="flex gap-6 max-md:flex-col">
											<div className="w-full">
												<label className="label-text" htmlFor="userdate">
													Enter The Date
												</label>
												<div className="input input-lg">
													<input
														type="text"
														className="flatpickr-date grow"
														placeholder="06/11/25"
														id="userdate"
													/>
													<span className="icon-[tabler--calendar-event] text-base-content/80 size-5.5 my-auto ms-3 shrink-0" />
												</div>
											</div>
											<div className="w-full">
												<label className="label-text" htmlFor="usertime">
													Enter Time
												</label>
												<div className="input input-lg">
													<input
														...
														id="usertime"
													/>
													<span className="icon-[tabler--calendar-time] text-base-content/80 size-5.5 my-auto ms-3 shrink-0" />
												</div>
											</div>
										</div>
										<div>
											<label className="label-text" htmlFor="usermessage">
												Message
											</label>
											<div className="textarea">
												<textarea
													...
													defaultValue={""}
												/>
												<span className="icon-[tabler--message-circle-2] text-base-content/80 mx-4 mt-2 size-6 shrink-0" />
											</div>
										</div>
										<button
											type="submit"
											className="btn btn-primary btn-gradient w-full"
										>
											Book a Reservation
										</button>
									</form>
								...
								<div className="space-y-6 lg:col-span-3">
									<div className="border-base-content/20 rounded-box border p-6 text-center">
										<h3 className="text-base-content mb-4 text-xl font-semibold">
											Email/Phone
										</h3>
										<p className="text-base-content/80 mb-2 break-all">
											johndoe@gmail.com
										</p>
										<p className="text-base-content/80">+148 589 2001 2466</p>
									</div>
									<div className="border-base-content/20 rounded-box border p-6 text-center">
										<h3 className="text-base-content mb-4 text-xl font-semibold">
											Our Location
										</h3>
										<p className="text-base-content/80">Office 149,</p>
										<p className="text-base-content/80">
											450 South Brand Brooklyn
										</p>
										<p className="text-base-content/80">San Diego County,</p>
										<p className="text-base-content/80">CA 91905, USA</p>
									</div>
									<p className="text-base-content text-center font-medium">
										Opening Hours
										<span className="text-primary">9AM - 11PM</span>
										Everyday
									</p>
								</div>
							</div>
			...
			{/* FAQ */}
			<section id="faqs">
				<div className="bg-base-100 relative h-full py-8 sm:py-16 lg:py-24">
					<div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
						<span className="intersect:motion-preset-slide-right intersect:motion-duration-800 intersect:motion-opacity-0 intersect:motion-delay-600 absolute start-[15%]">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width={102}
								height={120}
							...
							>
								<g opacity="0.06">
									...
									/>
									<path
										d="M44.7303 82.2389L38.3477 79.918L29.1259 105.278L35.5086 107.599L44.7303 82.2389Z"
										fill="var(--color-primary)"
										fillOpacity="0.5"
									/>
									<path
									...
									/>
									<path
										d="M26.8203 20.9316L33.203 23.2526L46.623 37.0351L40.2406 34.7143L26.8203 20.9316Z"
										fill="var(--color-primary)"
										fillOpacity="0.4"
									/>
								</g>
						...
						<span className="intersect:motion-preset-slide-right intersect:motion-duration-800 intersect:motion-opacity-0 intersect:motion-delay-1200 absolute end-[15%] sm:max-md:end-[5%]">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width={166}
								height={181}
							...
							>
								<g opacity="0.06">
									...
									/>
									<path
										d="M106.263 118.478L97.7661 122.126L112.262 155.888L120.76 152.24L106.263 118.478Z"
										fill="var(--color-primary)"
										fillOpacity="0.5"
									/>
									<path
									...
									/>
									<path
										d="M31.3276 74.3447L39.825 70.6963L65.9923 71.8589L57.4953 75.5072L31.3276 74.3447Z"
										fill="var(--color-primary)"
										fillOpacity="0.4"
									/>
								</g>
						...
						<div className="mb-12 space-y-4 text-wrap text-center sm:mb-16 lg:mb-24">
							...
							<p className="text-base-content/80 text-xl">
								Levarage artificial intelligence algorithms to provide users
									...
									<div className="carousel-body h-full gap-12 opacity-0">
										...
										<div className="carousel-slide m-2">
											<div className="rounded-box hover:bg-base-100 hover:ring-primary p-4 text-center hover:ring">
												...
												<p className="text-base-content/80">
													Yes, we do! You can place your order directly through
													our website or via trusted food delivery platforms
													like Swiggy and Zomato. We ensure that all dishes are
													packed with care and delivered promptly, so you can
													enjoy restaurant-quality food in the comfort of your
													home.
												</p>
										...
										<div className="carousel-slide m-2">
											<div className="rounded-box hover:bg-base-100 hover:ring-primary p-4 text-center hover:ring">
												...
												<p className="text-base-content/80">
													Booking a table is simple and quick. Just head over to
													our reservation page, choose your preferred date and
													time, and confirm your booking in a few clicks. You’ll
													receive a confirmation instantly. Prefer to speak with
													someone? You can also call us directly.
												</p>
												<div className="group mt-5 flex items-center justify-center gap-2">
													<a
														href="#"
										...
										<div className="carousel-slide m-2">
											<div className="rounded-box hover:bg-base-100 hover:ring-primary p-4 text-center hover:ring">
												...
												<p className="text-base-content/80">
													We’re open every day from 11:00 AM to 11:00 PM,
													offering both lunch and dinner service. On weekends,
													we also serve a special brunch menu from 10:00 AM to
													1:00 PM. Holiday hours may vary, so be sure to check
													our website or follow us on social media for real-time
										...
										<div className="carousel-slide m-2">
											<div className="rounded-box hover:bg-base-100 hover:ring-primary p-4 text-center hover:ring">
												...
												<p className="text-base-content/80">
													...
													including credit/debit card payments, bank transfers,
													and online payment gateways. We also offer flexible
													payment plans for select travel packages.
												</p>
												<div className="group mt-5 flex items-center justify-center gap-2">
													<a
														href="#"
										...
										<div className="carousel-slide m-2">
											<div className="rounded-box hover:bg-base-100 hover:ring-primary p-4 text-center hover:ring">
												...
												<p className="text-base-content/80">
													Yes, we do! We offer a variety of vegan dishes that
													are both flavorful and satisfying. Our menu includes
													plant-based starters, mains, and even desserts.
												</p>
												<div className="group mt-5 flex items-center justify-center gap-2">
													<a
														href="#"
